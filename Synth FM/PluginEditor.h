...
private:
   ...
   GeneratorADSRAudioProcessor& audioProcessor;
    ...
    juce::Slider sliderModulationIndex;
    juce::Slider sliderModulationRatio;
    juce::Slider sliderPitchBend;
    juce::Slider sliderLFO;
    juce::Slider sliderWaveShaper;
    juce::Slider sliderModulatorShaper;
